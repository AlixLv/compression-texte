# objectif : compression d'un texte
# sans perte, texte pas dégradé
#  stocker référence et la bribe dans un  dictionnaire
...
def createList(string):
    # methode re.split(" separateur 1 | separateur 2 | separateur 3", string)
